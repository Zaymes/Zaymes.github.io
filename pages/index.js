    ...
    <div>
      ...
      <div className='h-full'>
        <div className='container mx-auto flex justify-center mt-32 mb-10 max-w-5xl space-x-14 '>
          ...
          <div className='mt-28'>
            <h1 className=' text-3xl text-neutral-700 font-semibold align-top'>Hello World! <Image src={hand} height={30} width={30} alt='hand' className='align-baseline' /></h1>
            <h3 className='text-3xl text-neutral-700 font-semibold'>I am James Shrestha</h3>
            <h2 className='text-red-600 mt-1'>Software Developer | Open Data Advocate</h2>
            ...
            <div className='text-neutral-600 mt-2 flex'>
        ...
        <div className='fixed flex-none right-20 bottom-20 text-blue-700 text-sm font-normal'>
        ...
        <div className='max-w-4xl mx-auto mt-26 h-full'>
          <h2 className='max-w-fit  mx-auto pt-10 text-2xl font-bold text-neutral-700 mb-5' id='about' > About Me</h2>
          <div className='border-slate-100 drop-shadow-lg border-2 border-slate-100 rounded-lg h-full pb-12 mx-auto w-11/12 bg-no-repeat bg-contain'>
            <p className='px-20 pt-12 text-base font-normal text-neutral-700'>I am a software engineer specialized in building data management plaforms. Beside development I like to play with data and advocate for open data and technology as I believe knowledge should create power for many not the few. Here are some technologies I am working with.</p>
            <div className='px-20 w-9/12 mt-4 grid grid-cols-2'>
              <p className='flex text-neutral-700 font-thin text-sm pt-0.25'> <Image src={arrow} height={20} width={20} alt='arrow' />Javascrpit ES6+</p>
              <p className='flex text-neutral-700 font-thin text-sm pt-0.25'> <Image src={arrow} height={20} width={20} alt='arrow' /> Python</p>
              <p className='flex text-neutral-700 font-thin text-sm pt-0.25'> <Image src={arrow} height={20} width={20} alt='arrow' /> React.js</p>
              <p className='flex text-neutral-700 font-thin text-sm pt-0.25'> <Image src={arrow} height={20} width={20} alt='arrow' /> Next.js</p>
              <p className='flex text-neutral-700 font-thin text-sm pt-0.25'> <Image src={arrow} height={20} width={20} alt='arrow' /> Django</p>
              <p className='flex text-neutral-700 font-thin text-sm pt-0.25'> <Image src={arrow} height={20} width={20} alt='arrow' /> HTML & CSS</p>
            </div>
          </div>
        </div>
        <div className='max-w-4xl mx-auto h-full mb-10'>
          <div className='mx-auto w-11/12'>
            <h2 className='max-w-fit mx-auto pt-10 text-2xl font-bold text-neutral-700 mb-6 ' id='experience' > Experiences</h2>
            <div className='mb-4'>
              <h2 className='text-lg font-semibold text-neutral-700 mb-1' >Engagements</h2>
              <p className='text-base font-medium text-neutral-700'>Chief Operating Officer - Open Knowledge Nepal</p>
              <p className='text-base font-normal text-slate-600'>2021 - Present</p>
            </div>
            <div className='mb-4'>
              <h2 className='text-lg font-semibold text-neutral-700 mb-1'>Works</h2>
              <p className='text-base font-medium text-neutral-700'>Frontend Developer - Open Knowledge Nepal</p>
              <p className='text-base font-normal text-slate-600 mb-1'>2021 - Present</p>
              <p className='text-base font-medium text-neutral-700'>Data Analyst - Open Knowledge Nepal</p>
              <p className='text-sm font-normal text-slate-600'>2021 - 2022</p>
            </div>
            <div className='mb-4'>
              <h2 className='text-lg font-semibold text-neutral-700 mb-1'>Talks and Presentations</h2>
              <p className='text-base font-medium text-neutral-700'>Open Data and Why Does It Matter - Undergraduate Colleges</p>
              <p className='text-base font-normal text-slate-600'>Pre-events for OSM Hackfest 2022</p>
            </div>
          </div>
        </div>
        <div className='max-w-4xl mx-auto h-500 mb-10 h-100 '>
          <h2 className='max-w-fit mx-auto pt-10 text-2xl font-bold text-neutral-700 mb-10 ' id='projects'> Projects</h2>
          <Carousel />
          <Projects />
        </div>
